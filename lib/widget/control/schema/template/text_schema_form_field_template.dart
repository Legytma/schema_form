...
class TextSchemaFormFieldTemplate
    extends WidgetTemplate<TextSchemaFormFieldWidget> {
  final Key key;
  ...
  TextSchemaFormFieldWidget createWidgetInstance(
    ...
    return TextSchemaFormFieldWidget(
      ...
      dateFormat: getAditionalPropertyValue(
          "dateFormat", aditionalProperties, dateFormat),
      ...
      pickerType: getAditionalPropertyValue(
          "pickerType", aditionalProperties, pickerType),
    );
  }
}
